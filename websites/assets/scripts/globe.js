...
const sphere = new THREE.Mesh(
  ...
  new THREE.MeshBasicMaterial({ color: THEME.globeGrid, wireframe: true, transparent: true, opacity: 0.55 })
);
...
globeGroup.add(new THREE.Points(dg, new THREE.PointsMaterial({ color: THEME.accent, size: 0.018, transparent: true, opacity: 0.8 })));
...
[[Math.PI/2,0,THEME.accent,0.25],[Math.PI/3,Math.PI/5,THEME.globeRing,0.18]].forEach(([rx,ry,col,op]) => {
...
cg.setAttribute('position', new THREE.Float32BufferAttribute(constellationSegments, 3));
